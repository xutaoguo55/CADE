...
- Public GitHub repository and Zenodo DOI are tracked in `.zenodo.json` and `CITATION.cff`; final URL/DOI values will be set when the repository and DOI are minted at acceptance.
